/*** parallax.js ***/
$(document).ready(function(){"use strict";var o=$(".parallax");$.onResize=function(){"pc"===device&&$.onScroll()},$.onScroll=function(){var e,n,i=$(window).scrollTop();$(window).height();for(n=0;n<o.length;n++)(e=$(o[n])).css("background-position","0 "+parseFloat(-.6*(i-e.offset().top))+"px")},$.scrollToSection=function(o){var e=$("#"+o);$(window).scrollTo(e.offset().top+(e.outerHeight()/2-$(window).height()/2),700,{axis:"y",easing:"easeInOutQuad"})},$(window).resize($.onResize),"pc"===device&&($(window).scroll($.onScroll),$.onResize()),o.each(function(o){$(this).css("background-image","url(/theme/parallax_"+(o+1)+".jpg)")})});
...
/*** slick.min.js ***/
$(document).ready(function(){$(".slick .cms_featuregallery_empty").remove()});
...
/*** site_scripts.js ***/
$(document).ready(function(){$("#hmenu, .mod_navigation").find(".haschildren").each(function(e,s){var l=$(s);$(s).find("li").each(function(e,s){$(s).hasClass("current")&&l.addClass("current")})}),$(window).scroll(function(){$(this).scrollTop()>100?$(".scrollup").fadeIn():$(".scrollup").fadeOut()}),$(".scrollup").click(function(){return $("html, body").animate({scrollTop:0},600),!1}),$(".c_home").slick({dots:!1,slide:"li",infinite:!0,speed:600,slidesToShow:4,slidesToScroll:1,responsive:[{breakpoint:970,settings:{slidesToShow:1,slidesToScroll:1}}]}),$(".noticias_m").slick({dots:!1,vertical:!0,slide:"li",infinite:!1,speed:600,slidesToShow:2,slidesToScroll:1});new Waypoint.Sticky({element:$(".top")[0]});$("#map_canvas1").addClass("scrolloff"),$("#canvas1").on("click",function(){$("#map_canvas1").removeClass("scrolloff")}),$("#map_canvas1").mouseleave(function(){$("#map_canvas1").addClass("scrolloff")}),$(".picturegallerypicture").fancybox({beforeLoad:function(){this.title="Imagen "+(this.index+1)+" de "+this.group.length+(this.title?" - "+this.title:"")},helpers:{title:{type:"outside"}}}),$(".news .mod_featuregallery_text").shorten(),$(".blog .mod_featuregallery_text").shortenb(),$(".noticias_m .mod_featuregallery_text, .noticias_m1 .mod_featuregallery_text").shorten(),$(".navbar-toggle").click(function(){$(this).parent().find("#menu_phone").slideToggle()}),$("#map_canvas1").addClass("scrolloff"),$("#canvas1").on("click",function(){$("#map_canvas1").removeClass("scrolloff")}),$("#map_canvas1").mouseleave(function(){$("#map_canvas1").addClass("scrolloff")})});
